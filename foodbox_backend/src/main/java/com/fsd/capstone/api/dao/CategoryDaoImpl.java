...
import com.fsd.capstone.api.repository.CategoryRepository;
...
public class CategoryDaoImpl implements CategoryDao {
	...
	public Category save(Category category) throws FoodBoxDaoException {
		...
		try {
			com.fsd.capstone.api.entity.Category entity = mapper.toEntity(category);
	...
	public Category update(Category category) throws FoodBoxDaoException {
		...
		try {
			com.fsd.capstone.api.entity.Category current =
	...
	public byte[] getCategoryImage(Long id) throws FoodBoxDaoException {
		...
		try {
			com.fsd.capstone.api.entity.Category category =
